...
<input type="text" id="name" name="name" value="Hammad"><br><br>
<label for="address">Address: &nbsp;</label>
<input type="text" id="address" name="address" value="Attock"><br><br>
<label for="telNo">Tel.No.: &nbsp;</label>
<input type="text" id="telNo" name="telNo" value="03078963656"><br><br>
<label for="email">Email: &nbsp;</label>
<input type="text" id="email" name="email" value="hammadmalik137"><br><br>
